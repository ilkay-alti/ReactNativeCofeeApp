const coffee = [
  {
    ...
    price: "39.99",
    like: true,
    img: require("../assets/caffe-americano.png"),
    about:
...

  {
    ...
    price: "29.99",
    like: false,
    img: require("../assets/caffe-americano2.png"),
    about:
  ...
  },
  {
    ...
    price: "25.99",
    like: false,
    img: require("../assets/caffe-americano3.png"),
    about:
...

  {
    ...
    price: "25.99",
    like: true,
    img: require("../assets/caffe-americano4.png"),
    about:
  ...
  },
  {
    ...
    price: "50.99",
    like: true,
    img: require("../assets/caffe-americano5.png"),
    about:
      "Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.",
  },
  {
